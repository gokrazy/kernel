...
RUN apt-get update && apt-get install -y crossbuild-essential-arm64 build-essential bc libssl-dev bison flex libelf-dev ncurses-dev ca-certificates zstd kmod python3
